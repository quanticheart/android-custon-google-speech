...
class RippleView(context: Context?, private val attrs: AttributeSet?) :
    ...
    init {
        ...
        rippleScale =
            styledAttributes.getFloat(R.styleable.RippleView_rv_scale, DEFAULT_RIPPLE_SCALE)
    ...
    fun newRipple() {
        val circleView =
            CircleView(context, attrs, rippleColor, rippleType, rippleStrokeWidth).apply {
    ...
    private fun randomAnimationDuration() =
